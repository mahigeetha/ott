...
import 'Mycart.dart';
class Redgirl extends StatefulWidget {
  const Redgirl({Key? key}) : super(key: key);

  @override
  State<Redgirl> createState() => _RedgirlState();
}

class _RedgirlState extends State<Redgirl> {
  @override
          ...
          children: [
              ...
              child: Row(
                children: [
                  RichText(textAlign: TextAlign.start,
                      text:TextSpan(
                          children:<TextSpan> [
                            TextSpan(text: 'MRP ₹5000',style: TextStyle(color: Colors.grey,decoration:TextDecoration.lineThrough,fontSize: 18) ),
            ...
            Column(
              children: [
                ...
                Row(
                  children: [
                    Text('  Colour: Red',style: TextStyle(
                  ...
                  Padding(
                    ...
                    child: Container(
                        ...
                        child: Stack(
                          ...
                          children: [
                            Text('black',style: TextStyle(color: Colors.black87),)
                          ],
                        )
                    ),
                  ),
                          ...
                          Column(
                            children: [
                              ListTile(
                                ...
                                subtitle: Text('Gown',style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 18),),
                              ),
                              ListTile(
                                title: Text('Colour',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                                subtitle: Text('Red',style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 18),),
                              ),

                              ListTile(
                                title: Text('Length',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                                subtitle: Text('Floor Length',style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 18),),
                              ), ListTile(
                                title: Text('Character',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                                subtitle: Text('None',style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 18),),
                              )
                            ],
                          ),
