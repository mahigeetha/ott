...
import 'Mycart.dart';
class Sunglass extends StatefulWidget {
  const Sunglass({Key? key}) : super(key: key);

  @override
  State<Sunglass> createState() => _SunglassState();
}

class _SunglassState extends State<Sunglass> {
  @override
                ...
                itemBuilder: (BuildContext context,int itemIndex,int pageViewIndex){
                  return Container(
                      ...
                      decoration: BoxDecoration(
                          image: DecorationImage(image: AssetImage('assets/glass.jpg'),
                              fit: BoxFit.fill)
                      ),
                      child:Column(
                        children: [
              ...
              child: Row(
                children: [
                  RichText(textAlign: TextAlign.start,
                      text:TextSpan(
                          children:<TextSpan> [
                            TextSpan(text: 'MRP ₹2500',style: TextStyle(color: Colors.grey,decoration:TextDecoration.lineThrough,fontSize: 18) ),
                      ...
                      Column(
                        children: [
                          ...
                          Column(
                            children: [
                              ListTile(
                                title: Text('Frame Colour',style: TextStyle(
                                    color: Colors.black,fontWeight: FontWeight.bold),),
                                subtitle: Text('Black',style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 18),),
                              ),
                              ListTile(
                                title: Text('Frame Finish',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                                subtitle: Text('Glossy',style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 18),),
                              ),

                              ListTile(
                                title: Text('UV Protection Level',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                                subtitle: Text('UV400',style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 18),),
                              ), ListTile(
                                title: Text('Usage',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                                subtitle: Text('Day & Night',style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 18),),
                              )
                            ],
                          ),
