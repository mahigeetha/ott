      ...
      SingleChildScrollView(
        child: Column(
          children: [
            ...
            ListTile(
                leading: Text('Do Bhai _ Men Red shirt',
              ...
              child: Row(
                children: [
                  RichText(textAlign: TextAlign.start,
                      text:TextSpan(
                          children:<TextSpan> [
                            TextSpan(text: 'MRP ₹2,199',style: TextStyle(color: Colors.grey,decoration:TextDecoration.lineThrough,fontSize: 18) ),
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        alignment: Alignment.bottomCenter,
                        children: [
                          Text('Red',style: TextStyle(color: Colors.black87),)
                        ],
                      ),
                    ),
                  ),
