                ...
                itemBuilder: (BuildContext context,int itemIndex,int pageViewIndex){
                  return Container(
                      ...
                      decoration: BoxDecoration(
                          image: DecorationImage(image: AssetImage('assets/aa1.jpg'),
                              fit: BoxFit.fill)
                      ),
                      child:Column(
                        children: [
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        ...
                        children: [
                          Text('Aluminium',style: TextStyle(color: Colors.black87),)
                        ],
                      ),
                    ),
                  ),
                          ...
                          Column(
                            children: [
                              ListTile(
                                ...
                                subtitle: Text('Squeezer',style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 18),),
                              ),
                              ListTile(
                                title: Text('Material',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                                subtitle: Text('Aluminium',style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 18),),
                              ),
                              ListTile(
                                title: Text('Colour',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                                subtitle: Text('Silver',style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 18),),
                              ),
