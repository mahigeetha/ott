          ...
          children: [
              ...
              child: Row(
                children: [
                  RichText(textAlign: TextAlign.start,
                      text:TextSpan(
                          children:<TextSpan> [
                            TextSpan(text: 'MRP ₹499',style: TextStyle(color: Colors.grey,decoration:TextDecoration.lineThrough,fontSize: 18) ),
            ...
            Column(
              children: [
               ...
               Row(
                 children: [
                   Text('  Colour: Black',style: TextStyle(
  ...
  height: 2,
                      ...
                      Column(
                        ...
                        Column(
                          children: [
                            ListTile(
                              title: Text('Material Type',style: TextStyle(
                                  color: Colors.black,fontWeight: FontWeight.bold),),
                              subtitle: Text('EVA Rubber',style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 18),),
                            ),
                            ListTile(
                              title: Text('Closure type',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                              subtitle: Text('Zip',style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 18),),
                            ),
                            ListTile(
                              title: Text('Heel Type',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                              subtitle: Text('block Heel',style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 18),),
                            ),
                            ListTile(
                              title: Text('Water Resistance Level2',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                              subtitle: Text('EVA Rubber',style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 18),),
                            )
                          ],
                        ),
