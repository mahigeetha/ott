              ...
              child: Row(
                children: [
                  RichText(textAlign: TextAlign.start,
                      text:TextSpan(
                          children:<TextSpan> [
                            TextSpan(text: 'MRP ₹1800',style: TextStyle(color: Colors.grey,decoration:TextDecoration.lineThrough,fontSize: 18) ),
                ...
                children: [
                  RichText(text: TextSpan(style: TextStyle(fontSize: 17),
                      children: <TextSpan>[
                        ...
                        TextSpan(text: 'Wednesday, 6 September. ',
                          ...
                          Column(
                            children: [
                              ...
                              ListTile(
                                ...
                                subtitle: Text('Cartoon',style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 18),),
                              )
                            ],
                          ),
