...
import 'Mycart.dart';
class Vsaree extends StatefulWidget {
  const Vsaree({Key? key}) : super(key: key);

  @override
  State<Vsaree> createState() => _VsareeState();
}

class _VsareeState extends State<Vsaree> {
  @override
                ...
                itemBuilder: (BuildContext context,int itemIndex,int pageViewIndex){
                  return Container(
                      ...
                      decoration: BoxDecoration(
                          image: DecorationImage(image: AssetImage('assets/purplesaree.jpg'),
                              fit: BoxFit.fill)
                      ),
                      child:Column(
                        children: [
              ...
              child: Row(
                children: [
                  RichText(textAlign: TextAlign.start,
                      text:TextSpan(
                          children:<TextSpan> [
                            TextSpan(text: 'MRP ₹1500',style: TextStyle(color: Colors.grey,decoration:TextDecoration.lineThrough,fontSize: 18) ),
                  ...
                  Padding(
                    ...
                    child: Container(
                        ...
                        child: Stack(
                          ...
                          children: [
                            Text('Purple',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),)
                          ],
                        )
                    ),
                  ),
                      ...
                      Column(
                        children: [
                          ...
                          Column(
                            children: [
                              ListTile(
                                title: Text('Fabric',style: TextStyle(
                                    color: Colors.black,fontWeight: FontWeight.bold),),
                                subtitle: Text('Cotten Blend',style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 18),),
                              ),
                              ListTile(
                                title: Text('Colour',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                                subtitle: Text('Pink',style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 18),),
                              ),

                              ListTile(
                                title: Text('Blouse Colour',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                                subtitle: Text('Pink',style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 18),),
                              ),
                              ListTile(
                                title: Text('Set Contents',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                                subtitle: Text('With Blouse Piece',style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 18),),
                              ),
                              ListTile(
                                title: Text('Wash Care',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                                subtitle: Text('Dry Clean',style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 18),),
                              ),
                            ],
                          ),
