...
import 'Mycart.dart';
class Pinksaree extends StatefulWidget {
  const Pinksaree({Key? key}) : super(key: key);

  @override
  State<Pinksaree> createState() => _PinksareeState();
}

class _PinksareeState extends State<Pinksaree> {
  @override
      ...
      SingleChildScrollView(
        child: Column(
          children: [
            ...
            ListTile(
                leading: Text('Do Bhai _Pink color saree ',
            ...
            Column(
              children: [
                ...
                Row(
                  children: [
                    Text('  Colour: Pink',style: TextStyle(
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        alignment: Alignment.bottomCenter,
                        children: [
                          Text('purple',style: TextStyle(color: Colors.black87),)
                        ],
                      ),
                    ),
                  ),
                ...
                children: [
                  RichText(text: TextSpan(style: TextStyle(fontSize: 17),
                      children: <TextSpan>[
                        ...
                        TextSpan(text: 'Monday, 6 Septembr. ',
                          ...
                          Column(
                            children: [
                              ListTile(
                                ...
                                subtitle: Text('Samudrika Patty',style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 18),),
                              ),
                              ListTile(
                                title: Text('style',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                                subtitle: Text('Traditional',style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 18),),
                              ),
                              ListTile(
                                title: Text('Neck style',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                                subtitle: Text('Boat Neck blouse',style: TextStyle(color: Colors.black54,fontWeight: FontWeight.bold,fontSize: 18),),
                              ),
                              ListTile(
